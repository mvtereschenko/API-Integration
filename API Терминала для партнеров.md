...
* [API Терминала для партнеров: записать в итоговый чек экстра данные интеграции](#006)
...
<a name="006"></a>
### API Терминала для партнеров: записать в итоговый чек экстра данные интеграции
`В процессе разработки Терминала`
